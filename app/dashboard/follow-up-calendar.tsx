                ...
                <>
                  <div className="flex gap-0.5 mt-0.5">
                    {dayFollowUps.length <= 3
                      ? dayFollowUps.map((_, i) => <span key={i} className="w-1.5 h-1.5 rounded-full bg-blue-500" />)
                      : <>
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 z-10 hidden group-hover:block w-48 bg-popover border rounded-md shadow-md p-2 mt-1">
                    {dayFollowUps.map((fu) => (
                      <div key={fu.id} className="text-xs py-1 border-b last:border-0">
