...
- **Companies** -- Track target companies with website, LinkedIn, industry, size, and description. Import basic info from any company URL. Add personal notes with inline editing. Each company page shows all associated roles and contacts in one place.
